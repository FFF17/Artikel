        ...
        <div class="header">
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="{{url('berita/index')}}">
                        <!-- Logo icon -->
                        <b><img src="{{ asset('assets/img/logo.png')}}" alt="homepage" class="dark-logo" /></b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                    ...
                    <div class="scroll-sidebar">
                        ...
                        <nav class="sidebar-nav">
                            <ul id="sidebarnav">
                                ...
                                <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-file"></i><span class="hide-menu">Artikel</span></a>
                                    <ul aria-expanded="false" class="collapse">
                                        <li><a href="{{url('berita/index')}}">List Artikel</a></li>
                                        <li><a href="{{url('berita/create')}}">Tambah Artikel</a></li>
                                        <li><a href="{{url('berita/page')}}">Halaman</a></li>
                                    </ul>
                             </li>
                            </ul>
                        </nav>
                ...
                <!-- Page wrapper  -->
                @yield('content')
                <footer class="footer"> © 2018 All rights reserved. Template designed by Ela</a></footer>
                <!-- End Page wrapper  -->
            </div>
            <!-- End Wrapper -->
