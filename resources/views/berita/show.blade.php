			...
			<div class="container main-menu" id="main-menu">
				<div class="row align-items-center justify-content-between">
					<nav id="nav-menu-container">
						<ul class="nav-menu">
							<li class="menu-active"><a href="/berita/index">Home</a></li>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="hero-nav-area">
								...
								<p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span><a href="#">Artikel</a><span class="lnr lnr-arrow-right"></span><a href="image-post.html">{{$tampilkan->judul}}</a></p>
							</div>
						</div>
						<div class="col-lg-12">
						...
						<div class="col-lg-8 post-list">
							...
							<div class="single-post-wrap">
								<div class="feature-img-thumb relative">
									...
									<img class="img-fluid" src="{{asset('image/'.$tampilkan->image)}}" alt="">
								</div>
								<div class="content-wrap">
									...
									<a href="#">
										<h3>{{$tampilkan->judul}}</h3>
									</a>
									<ul class="meta pb-20">
										<li><a href="#"><span class="lnr lnr-user"></span>Admin</a></li>
										<li><a href="#"><span class="lnr lnr-calendar-full"></span>{{$tampilkan->created_at}}</a></li>
									</ul>
									<p>
											{{$tampilkan->isi}}
									</p>
					...
					<div class="col-lg-4">
						<div class="sidebars-area">
							...
							<div class="single-sidebar-widget ads-widget">
								<img class="img-fluid" src="/assets/img/sidebar-ads.jpg" alt="">
							</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
	...
	<script src="/assets/https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script>
