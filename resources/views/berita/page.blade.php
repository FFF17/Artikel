            ...
            <div class="container main-menu" id="main-menu">
                <div class="row align-items-center justify-content-between">
                    <nav id="nav-menu-container">
                        <ul class="nav-menu">
                            <li class="menu-active"><a href="{{url('/berita/index')}}">Home</a></li>
                    ...
                    <div class="row small-gutters">
                        ...
                        <div class="col-lg-4 top-post-right">
                            ...
                            <div class="single-top-post mt-10">
                                <div class="feature-image-thumb relative">
                                    <div class="overlay overlay-bg"></div>
                                    <img class="img-fluid" src="/assets/img/a8.jpeg" alt="">
                                </div>
                                <div class="top-post-details">
                                    <ul class="tags">
                                        <li><a href="#">Food Habit</a></li>
                        ...
                        <div class="col-lg-8 post-list">
                            ...
                            <div class="latest-post-wrap">
                                ...
                                @if(count($berita) >= 4)
                                    ...
                                    <a class="prev" href="{{url('welcome?page='.$pagePrev)}}"><span class="lnr lnr-arrow-left"></span>Prev Post</a>
                                    <a class="next" href="{{url('welcome?page='.$pageNext)}}">Next Post<span class="lnr lnr-arrow-right"></span></a>
                                </div>
                            @else
                                ...
                                <div class="row mt-20 medium-gutters">
                                    ...
                                    <div class="col-lg-6 single-popular-post">
                                        <div class="feature-img-wrap relative">
                                            <div class="feature-img relative">
                                                <div class="overlay overlay-bg"></div>
                                                <img class="img-fluid" src="/assets/img/a7.jpg" alt="">
                                            </div>
                                            <ul class="tags">
                                                <li><a href="#">Food</a></li>
                                            </ul>
                                ...
                                <div class="relavent-story-list-wrap">
                                    ...
                                    <div class="single-relavent-post row align-items-center">
                                        <div class="col-lg-5 post-left">
                                            <div class="feature-img relative">
                                                <div class="overlay overlay-bg"></div>
                                                <img class="img-fluid" src="/assets/img/a4.jpg" alt="">
                                            </div>
                                            <ul class="tags">
                                                <li><a href="#">Food</a></li>
                                            </ul>
                                    ...
                                    <div class="single-relavent-post row align-items-center">
                                        <div class="col-lg-5 post-left">
                                            <div class="feature-img relative">
                                                <div class="overlay overlay-bg"></div>
                                                <img class="img-fluid" src="/assets/img/a5.jpg" alt="">
                                            </div>
                                            <ul class="tags">
                                                <li><a href="#">Food</a></li>
                                            </ul>
                                    ...
                                    <div class="editors-pick-post">
                                        ...
                                        <div class="post-lists">
                                            <div class="single-post d-flex flex-row">
                                                ...
                                                <div class="detail">
                                                    <a href="{{url('about-post')}}"><h6>Help Finding Information
                                            ...
                                            <div class="single-post d-flex flex-row">
                                                <div class="thumb">
                                                    <img src="/assets/img/e3.jpg" alt="">
                                                </div>
                                                <div class="detail">
                                                    <a href="{{url('about-post')}}"><h6>Compatible Inkjet Cartr
                                                    world famous</h6></a>
                                                    <ul class="meta">
                                                        <li><a href="#"><span class="lnr lnr-calendar-full"></span>03 April, 2018</a></li>
                                                        <li><a href="#"><span class="lnr lnr-bubble"></span>06</a></li>
                                            ...
                                            <div class="single-post d-flex flex-row">
                                                <div class="thumb">
                                                    <img src="/assets/img/e4.jpg" alt="">
                                                </div>
                                                <div class="detail">
                                                    <a href="{{url('about-post')}}"><h6>5 Tips For Offshore Soft
                                                    Development </h6></a>
                                                    <ul class="meta">
                                                        <li><a href="#"><span class="lnr lnr-calendar-full"></span>03 April, 2018</a></li>
                                                        <li><a href="#"><span class="lnr lnr-bubble"></span>06</a></li>
